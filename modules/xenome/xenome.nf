process XENOME_CLASSIFY {
    ...
    if (params.read_type == "SE")
        ...
        fastq-sort --id human_1.fastq > human_sorted_1.fastq
        fastq-sort --id mouse_1.fastq > mouse_sorted_1.fastq
        gzip -c human_sorted_1.fastq > ${sampleID}_sorted_human_1.fastq.gz
        ...
        fastq-sort --id human_2.fastq > human_sorted_2.fastq
        fastq-sort --id mouse_2.fastq > mouse_sorted_2.fastq
        gzip -c human_sorted_2.fastq > ${sampleID}_sorted_human_2.fastq.gz
