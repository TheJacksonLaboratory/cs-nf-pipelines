...
--haplotype_list | <comma,delim,string> | A list of haplotype names corresponding to genomes used in hybrid genome construction (e.g., 'A,B,C,D,E,F,G,H'). These names are appended to transcript IDs (e.g., ENMST00000042_A). NOTE: HAPLOTYPE LIST MUST BE IN THE SAME ORDER AS FASTA AND GTF FILES. 
