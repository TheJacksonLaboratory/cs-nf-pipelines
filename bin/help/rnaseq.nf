...
| `--picard_dict`     | `'/projects/omics_share/mouse/GRCm38/genome/sequence/ensembl/v102/Mus_musculus.GRCm38.dna.toplevel.dict'`                                    | The coverage metric calculation step requires this file. Refers to human assembly when `--gen_org human`. JAX users should not change this parameter.                  |
| `--ref_flat`        | `'/projects/omics_share/mouse/GRCm38/transcriptome/annotation/ensembl/v102/Mus_musculus.GRCm38.102.chr_patch_hapl_scaff.refFlat.txt'`        | The coverage metric calculation step requires this file. Refers to human assembly when `--gen_org human`. JAX users should not change this parameter.                  |
| `--ribo_intervals`  | `'/projects/omics_share/mouse/GRCm38/transcriptome/annotation/ensembl/v102/Mus_musculus.GRCm38.102.chr_patch_hapl_scaff.rRNA.interval_list'` | The coverage metric calculation step requires this file. Refers to human assembly when `--gen_org human`. JAX users should not change this parameter.                  |
